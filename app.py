...
# # - chatbot: Instance of CandidateChatbot
# # - messages: List of conversation messages displayed in the chat
# # - language_selected: Boolean to track if user has selected a language
# # - selected_language: String storing the user's selected language code
# # - translator: Translator instance from googletrans for handling translation
